...
public class NcpObjectStorage {
    ...
    public  void putObjectAcl(String bucketName, String objectName, String localFilePath) throws Exception {
        putObject(bucketName , objectName , localFilePath , "public-read");
    }

    public int putObjectAcl(String objectName, String localFilePath) throws Exception {
        return putObject(BUCKET_NAME , "image/" + objectName , localFilePath , "public-read");
    }

    public int putObjectAclMultiPart(String objectName, MultipartFile imgFile) throws Exception {
        return putObject(BUCKET_NAME , "image/" + objectName , imgFile , "public-read");
    }

    public int putObject(String bucketName, String objectName, MultipartFile imgFile , String aclHeader) throws Exception {
        HttpClient httpClient = HttpClientBuilder.create().build();

        HttpPut request = new HttpPut(ENDPOINT + "/" + bucketName + "/" + objectName);
        request.addHeader("Host", request.getURI().getHost());
        if(aclHeader != null && !aclHeader.isEmpty()) {
    ...
    public int putObject(String bucketName, String objectName, String localFilePath , String aclHeader) throws Exception {
        HttpClient httpClient = HttpClientBuilder.create().build();
    ...
    private static final String BUCKET_NAME = "bps";
    ...
    private static final String ACCESS_KEY = "s81xuIlGAONVlGtzBK3Y";
    private static final String SECRET_KEY = "n4uomSb0Obwa7N8YJgHTioxwPXTtqlu9QeY2Vt6W";
}
